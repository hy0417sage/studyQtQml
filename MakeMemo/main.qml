...
Window {
    ...
    Item {
        ...
        ListModel {
            id: planets
            ListElement { name: "M"; imageSource: "Resources/about.jpeg"; facts:
    ...
    ˓→the sun. It makes one trip around the Sun once every 87.969 days." }
            ListElement { name: "V"; imageSource: "images/venus.jpeg"; facts:
    ...
    ˓→Mars. Astronomers have known Venus for thousands of years." }
            ListElement { name: "E"; imageSource: "images/earth.jpeg"; facts: "The
    ...
    ˓→'Planet Earth', and 'Terra'." }
            ListElement { name: "M"; imageSource: "images/mars.jpeg"; facts: "Mars
